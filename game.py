...
def remove_punct(text):
    ...
    not be removed. The function takes a string and returns a new string which does not contain any punctuation. For example:
...
def menu(exits):
    ...
    while True:   
        ...
        chosen_exit = input()
        # Read player's input
        normalise_exit = normalise_input(chosen_exit)
        # Normalise the input
        for exit in exits:
